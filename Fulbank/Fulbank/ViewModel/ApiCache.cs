...
namespace Fulbank.ViewModel
{
    public static class ApiCache
    {
        ...
        {
            string url = $"https://api.coingecko.com/api/v3/simple/price?ids={crypto}&vs_currencies=usd,eur&precision=full";
            ...
            using (HttpClient client = new HttpClient())
            {
                ...
                decimal usdPrice = json[crypto]["usd"].Value<decimal>();
                decimal eurPrice = json[crypto]["eur"].Value<decimal>();

                return currency == "eur" ? eurPrice : usdPrice;
            }
        }
    }
